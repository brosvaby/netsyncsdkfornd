 ...
 */
public class RecentlyFragmentEx extends SDRecentlyFragment {

    private final String TAG = "RecentlyFragmentEx";
    
    public static RecentlyFragmentEx newInstance(String fragmentTag_key, String fragmentTag, String fragmentName_key, String fragmentName) {
        RecentlyFragmentEx newFragment = new RecentlyFragmentEx();
