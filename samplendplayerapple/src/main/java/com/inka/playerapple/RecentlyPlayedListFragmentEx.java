 ...
 */
public class RecentlyPlayedListFragmentEx extends ExplorerRecentlyFragment {

    private final String TAG = "RecentlyPlayedListFragmentEx";

    public static RecentlyPlayedListFragmentEx newInstance(String fragmentTag_key, String fragmentTag, String fragmentName_key, String fragmentName) {
        RecentlyPlayedListFragmentEx newFragment = new RecentlyPlayedListFragmentEx();
