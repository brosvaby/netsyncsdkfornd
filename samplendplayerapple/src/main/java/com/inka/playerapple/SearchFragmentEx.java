 ...
 */
public class SearchFragmentEx extends ExplorerSearchFragment {

    private final String TAG = "SearchFragmentEx";

    public static SearchFragmentEx newInstance() {
        SearchFragmentEx newFragment = new SearchFragmentEx();
