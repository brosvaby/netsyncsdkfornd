...
/**
 * Created by birdgang on 2018. 4. 4..
 */
public class ExplorerFragmentEx extends ExplorerFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mColorForReflesh = R.color.provider_color_actionbar_main_bg;
        mResDrawableActionBarBg = R.drawable.apple_actionbar;
    ...
    protected void requestSearchView() {
        Intent intent = new Intent(getActivity(), SearchActivityEx.class);
            ...
            if (StringUtil.isNotBlank(errorMessage) && getActivity().isFinishing() == false) {
                new CustomAlertDialog(getActivity())
                        ...
                        .setConfirmClickListener(
                                new CustomAlertDialog.OnSweetClickListener() {
                            @Override
    ...
    protected int provideProgressBarForLmsDrawable () {
        return R.drawable.apple_progress_lms;
    }
