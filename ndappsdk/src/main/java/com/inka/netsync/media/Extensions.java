...
public class Extensions {
    ...
    public final static HashSet<String> NCGDRM = new HashSet<String>();
    public final static HashSet<String> PDF = new HashSet<String>();
    ...
    static {
        ...
        final String[] ncgDrmExtensions = {".sd.ncg"};

        final String[] pdfExtensions = {".pdf" , ".PDF"};
        ...
        NCGDRM.addAll(Arrays.asList(ncgDrmExtensions));
        PDF.addAll(Arrays.asList(pdfExtensions));
