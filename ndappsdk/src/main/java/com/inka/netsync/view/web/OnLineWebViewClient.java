...
public class OnLineWebViewClient extends BaseWebViewClient {

    private static final String TAG = "OnLineWebViewClient";
    ...
    public OnLineWebViewClient (Context context, WebView webView, WebViewClientCallback callback, WebViewJavaScriptInterface jsCallback) {
