 ...
 */
public class OffLineWebViewClient extends BaseWebViewClient {

    private static final String TAG = "OffLineWebViewClient";
    ...
    public OffLineWebViewClient (Context context, WebView webView, WebViewClientCallback callback, WebViewJavaScriptInterface jsCallback) {
        ...
        if (url.contains("file:///android_asset")) {
            if (url.contains(".mp4")) {
                try {
                    ...
                    AssetsUtil.copyFileFromAssets(mContext, url.replace("file:///android_asset/", ""), targetFile);
