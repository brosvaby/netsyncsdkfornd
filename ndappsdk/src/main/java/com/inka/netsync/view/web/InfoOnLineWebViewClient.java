...
public class InfoOnLineWebViewClient extends WebViewClient {

    private static final String TAG = "InfoOnLineWebViewClient";
    ...
    public InfoOnLineWebViewClient(Context context, WebView webView, InfoWebViewClientCallback callback, WebViewJavaScriptInterface jsCallback) {
