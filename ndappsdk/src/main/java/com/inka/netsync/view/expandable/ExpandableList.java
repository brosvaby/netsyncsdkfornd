...
public class ExpandableList {
    ...
    public List<? extends ExpandableGroupEntry> groups;
    public boolean[] expandedGroupIndexes;

    public ExpandableList(List<? extends ExpandableGroupEntry> groups) {
        this.groups = groups;
    ...
    public int getFlattenedGroupIndex(ExpandableGroupEntry group) {
    ...
    public ExpandableGroupEntry getExpandableGroup(ExpandableListPosition listPosition) {
