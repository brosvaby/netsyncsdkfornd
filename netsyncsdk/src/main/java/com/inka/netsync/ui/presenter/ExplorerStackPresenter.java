...
public class ExplorerStackPresenter<V extends ExplorerStackMvpView> extends ExplorerPresenter<V> implements ExplorerStackMvpPresenter<V> {
    ...
    @Inject
    public ExplorerStackPresenter(DataManager dataManager, CompositeDisposable compositeDisposable) {
