...
public class SearchActivity extends BaseActivity implements SearchContainerMvpView {
    ...
    protected void setUp() {
        ...
        ExplorerSearchFragment searchFragment = (ExplorerSearchFragment) provideSearchFragment();
