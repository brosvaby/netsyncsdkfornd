...
/**
 * Created by birdgang on 2018. 5. 23..
 */
...
public class FancyButton extends LinearLayout {
    ...
    private int    mDefaultTextSize    = ThemeUtil.spToPx(getContext(), 15);
    private int    mDefaultTextGravity = 0x11; // Gravity.CENTER
    private String mText               = null;

    // # Icon Attributes
    private Drawable mIconResource = null;
    private int      mFontIconSize = ThemeUtil.spToPx(getContext(), 15);
    ...
    public FancyButton(Context context) {
        ...
        mTextTypeFace = ThemeUtil.findFont(mContext, mDefaultTextFont, null);
        mIconTypeFace = ThemeUtil.findFont(mContext, mDefaultIconFont, null);
    ...
    private TextView setupTextView() {
        ...
        textView.setTextSize(ThemeUtil.pxToSp(getContext(), mDefaultTextSize));
    ...
    private TextView setupFontIconView() {
        ...
        if (mFontIcon != null) {
            ...
            if (!isInEditMode()) {
                fontIconView.setTextSize(ThemeUtil.pxToSp(getContext(), mFontIconSize));
    ...
    private void initAttributesArray(TypedArray attrsArray) {
        ...
        if (!isInEditMode()) {
            mIconTypeFace = iconFontFamily != null
                    ? ThemeUtil.findFont(mContext, iconFontFamily, mDefaultIconFont)
                    : ThemeUtil.findFont(mContext, mDefaultIconFont, null);

            mTextTypeFace = textFontFamily != null
                    ? ThemeUtil.findFont(mContext, textFontFamily, mDefaultTextFont)
                    : ThemeUtil.findFont(mContext, mDefaultTextFont, null);
        }
    }
    ...
    public void setTextSize(int textSize) {
        this.mDefaultTextSize = ThemeUtil.spToPx(getContext(), textSize);
        if (mTextView != null)
    ...
    public void setFontIconSize(int iconSize) {
        this.mFontIconSize = ThemeUtil.spToPx(getContext(), iconSize);
        if (mFontIconView != null)
    ...
    public void setCustomTextFont(String fontName) {
        mTextTypeFace = ThemeUtil.findFont(mContext, fontName, mDefaultTextFont);
    ...
    public void setCustomIconFont(String fontName) {
        ...
        mIconTypeFace = ThemeUtil.findFont(mContext, fontName, mDefaultIconFont);
