package com.inka.netsync.view.meterial;
...
public class ObservableRecyclerView extends RecyclerView implements Scrollable {
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        LogUtil.INSTANCE.debug("birdgangmaterialviewpager", "onRestoreInstanceState: ");
    ...
    public Parcelable onSaveInstanceState() {
        ...
        LogUtil.INSTANCE.debug("birdgangmaterialviewpager", "onSaveInstanceState: ");
        return ss;
    }
            ...
            if (getChildCount() > 0) {
                ...
                if (firstVisibleChild != null) {
                    if (mPrevFirstVisiblePosition < firstVisiblePosition) {
                        ...
                        LogUtil.INSTANCE.debug("birdgangmaterialviewpager", "mPrevScrolledChildrenHeight1: " + mPrevScrolledChildrenHeight + " ,mPrevFirstVisiblePosition: " + mPrevFirstVisiblePosition + " ,firstVisiblePosition: " + firstVisiblePosition + " ,isOrientation: " + isOrientation);
                        ...
                        mPrevFirstVisibleChildHeight = firstVisibleChild.getHeight();
                        LogUtil.INSTANCE.debug("birdgangmaterialviewpager", "mPrevScrolledChildrenHeight2: " + mPrevScrolledChildrenHeight + " ,mPrevFirstVisibleChildHeight:" + mPrevFirstVisibleChildHeight);
                    } else if (firstVisiblePosition == 0) {
                        mPrevFirstVisibleChildHeight = firstVisibleChild.getHeight();
                        mPrevScrolledChildrenHeight = 0;
                        LogUtil.INSTANCE.debug("birdgangmaterialviewpager", "mPrevScrolledChildrenHeight3: " + mPrevScrolledChildrenHeight + " ,mPrevFirstVisibleChildHeight:" + mPrevFirstVisibleChildHeight);
                    }
                    ...
                    LogUtil.INSTANCE.debug("birdgangmaterialviewpager", "mScrollY: " + mScrollY+ " ,mPrevScrolledChildrenHeight: " + mPrevScrolledChildrenHeight + " ,firstVisibleChild.getTop(): " + firstVisibleChild.getTop() + " ,firstVisibleChild.getHeight(): " +firstVisibleChild.getHeight() + " ,skippedChildrenHeight: "+ skippedChildrenHeight + " ,mPrevFirstVisiblePosition: "+mPrevFirstVisiblePosition+" ,firstVisiblePosition: "+firstVisiblePosition+" ,lastVisiblePosition: "+lastVisiblePosition );
    ...
    public void setScrollChanged(int l, int t, int oldl, int oldt) {
