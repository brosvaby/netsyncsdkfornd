...
public class ListSettingSwitchWithDescriptionViewHolder extends BaseViewHolder {
    ...
    public ListSettingSwitchWithDescriptionViewHolder(View itemView, int viewType) {
        super(itemView);
