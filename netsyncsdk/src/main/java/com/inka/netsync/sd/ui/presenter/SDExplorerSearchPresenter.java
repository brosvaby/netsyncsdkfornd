...
public class SDExplorerSearchPresenter<V extends SDExplorerSearchMvpView> extends BasePresenter<V> implements SDExplorerSearchMvpPresenter<V> {

    private final String TAG = "SDExplorerSearchPresenter";

    @Inject
    public SDExplorerSearchPresenter(DataManager dataManager, CompositeDisposable compositeDisposable) {
