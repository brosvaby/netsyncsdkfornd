 ...
 */
public class SDSettingPresenter<V extends SDSettingMvpView> extends BasePresenter<V> implements SDSettingMvpPresenter<V> {

    @Inject
    public SDSettingPresenter(DataManager dataManager, CompositeDisposable compositeDisposable) {
