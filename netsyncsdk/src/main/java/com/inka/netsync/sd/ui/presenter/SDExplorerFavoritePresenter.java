 ...
 */
public class SDExplorerFavoritePresenter<V extends SDExplorerFavoriteMvpView> extends BasePresenter<V> implements SDExplorerFavoriteMvpPresenter<V> {

    private final String TAG = "SDExplorerFavoritePresenter";

    @Inject
    public SDExplorerFavoritePresenter(DataManager dataManager, CompositeDisposable compositeDisposable) {
