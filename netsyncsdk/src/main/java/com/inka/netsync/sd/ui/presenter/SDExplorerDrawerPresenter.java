 ...
 */
public class SDExplorerDrawerPresenter<V extends SDExplorerDrawerMvpView> extends BasePresenter<V> implements SDExplorerDrawerMvpPresenter<V> {

    private final String TAG = "DrawerPresenter";

    @Inject
    public SDExplorerDrawerPresenter(DataManager dataManager, CompositeDisposable compositeDisposable) {
